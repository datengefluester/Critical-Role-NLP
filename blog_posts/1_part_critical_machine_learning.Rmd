...
As we have seen in our previous analysis, it sometimes happens that actors say the same thing simultaneously. If we considered each of these cases as distinct speakers (for example, 'Laura and Travis' as one speaker), we would increase the number of speakers we would need to predict to 110. Since some of these only happen once in the entire series, we omit these texts and stick to our ten speakers (the cast member and 'guests').
