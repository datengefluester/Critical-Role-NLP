...
write.csv(multinom_acc, "./data/machine_learning/multinominal_regression/multinominal_acc.csv", row.names = FALSE)
...
write.csv(multinom_predictions, "./data/machine_learning/multinominal_regression/multinominal_predictions.csv", row.names = FALSE)
